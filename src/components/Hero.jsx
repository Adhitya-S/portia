...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      >
        ...
        <div>
          ...
          <div className="flex mt-4 gap-4 z-10 relative">
            <a href="https://github.com/Adhitya-S" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
              <FaGithub className="text-white hover:text-[#915EFF] text-2xl" />
            </a>
            <a href="https://www.linkedin.com/in/adhitya-s-a4511912b" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <FaLinkedin className="text-white hover:text-[#915EFF] text-2xl" />
            </a>
            <a href="https://drive.google.com/file/d/1j5SA8hBIVlfFYzdJBNtKgenoX2SnlYqW/view?usp=share_link" target="_blank" rel="noopener noreferrer" aria-label="Resume">
      ...
      <div className="sm:hidden bg-[#915EFF] w-full h-[200px] flex justify-center items-center">
